...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.gooddream.kxmpzq"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
tasks.withType<Test>().configureEach {
  ...
  val builtInKotlincTestClasses = layout.buildDirectory.dir("intermediates/built_in_kotlinc/debugUnitTest/compileDebugUnitTestKotlin/classes")
  testClassesDirs = testClassesDirs + files(builtInKotlincTestClasses)
}
